REM Parametros OWNER, TABLE_NAME
--set echo off
--set scan on
--set lines 320
--set pages 100
...
column BLOCKS heading "Blocks" format 999,999,999,990
column EMPTY_BLOCKS heading "Empty|Blocks" format 999,999,999,990

column AVG_SPACE heading "Average|Space" format 9,999,999990
column CHAIN_CNT heading "Chain|Count" format 999,999,990
column AVG_ROW_LEN heading "Average|Row Len" format 999,999,990
...
column NUM_NULLS heading "Number|Nulls" format 99,999,999,990
column NUM_BUCKETS heading "Number|Buckets" format 999,999,990
...
column DISTINCT_KEYS heading "Distinct|Keys" format 9,999,999,999,990
column AVG_LEAF_BLOCKS_PER_KEY heading "Average|Leaf Blocks|Per Key" format 999,999,999,990
column AVG_DATA_BLOCKS_PER_KEY heading "Average|Data Blocks|Per Key" format 99,999,999990
column CLUSTERING_FACTOR heading "Cluster|Factor" format 999,999,999990
column COLUMN_POSITION heading "Col|Pos" format 999,999,990
column col heading "Column|Details" format a24
column COLUMN_LENGTH heading "Col|Len" format 999,999,990
column GLOBAL_STATS heading "Global|Stats" format a6
column USER_STATS heading "User|Stats" format a6
column SAMPLE_SIZE heading "Sample|Size" format 9,999,999999,990
