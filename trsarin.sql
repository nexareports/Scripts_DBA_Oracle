...
Prompt ATRIBUIR ROLES E SINÓNIMOS AO(S) USER(S)
GRANT RSAI_01 TO &&1;
@sinonimos_sarin
...
prompt Foram dados privilégios ao user &&1 para aceder ao SARIN.
prompt É favor testar
prompt O user &&1 possui privilégios para aceder ao SARIN.
prompt É favor testar
