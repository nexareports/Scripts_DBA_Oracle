...
SET DEF ON TERM ON ECHO ON FEED OFF VER OFF HEA ON LIN 2000 PAGES 100 LONG 8000000 LONGC 800000 TRIMS ON TI OFF TIMI OFF SERVEROUT ON SIZE 1000000 NUM 20 SQLP SQL>;
...
PRO
PRO Parameter 3:
PRO Description (can be null)
PRO
DEF description_profile = '&3';
PRO
WITH
p AS (
...
PRO DESCRIPTION: "&&description_profile."
PRO
...
BEGIN
  ...
  :name := 'Prof_'||TRIM('&&original_sql_id.')||'_'||'&&plan_hash_value.';
  :descript := '&&description_profile.';
