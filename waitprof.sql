...
PROMPT
PROMPT. @sess_uncommited_transactions      @sess_current_user_transactions  @waitprof <print|noprint> <sid> <e[123s]> <#samples>   @sw <sid>
prompt. @sess_users_active     @sess_users_active_sql  @sess_users         @sess_users_sql
prompt
