...
PROMPT Graph shows the load on the database measured in AAS. The + represent CPU acticity and - represent wait time
PROMPT the number 4 in the graph represents 4 cores on this machine, so we can see when AAS goes above the # of cores
PROMPT which is a sign of  a fair bit of contention
