...
select 'C:\Logs\Acessos\Acessos_Sirel_'||to_char(sysdate,'yyyymmdd_hh24mi')||'.log' arq from dual;
spool &Arquivo
...
prompt Foram dados privilégios ao user &&1 para aceder ao SIREL.
prompt É favor testar
prompt O user &&1 possui privilégios para aceder ao SIREL.
prompt É favor testar
